...
Create-react-project provides the most advanced state change monitoring available. First, download the StateMonitor react component from [here](https://github.com/AndrewBanks10/StateMonitor) and follow the installation instructions. Also, download this [vscode extension](https://github.com/AndrewBanks10/cr-state-file-open) and follow the installation instructions.
